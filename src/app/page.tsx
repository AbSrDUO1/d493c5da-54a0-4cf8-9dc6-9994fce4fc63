    ...
    <SiteThemeProvider theme={{ styleVariant: 'funAndTrendy', colorTemplate: 1, textAnimation: 'highlight' }}>
      ...
      <div id="tokenomics" data-section="tokenomics">
        <PatternTokenomics
          ...
          kpiItems={[
            { value: "100M", description: "Total Supply", icon: { Coin: { icon: 'Coin' } } },
            { value: "55M", description: "Circulating Supply", icon: { Wallet: { icon: 'Wallet' } } },
            { value: "45M", description: "Reserved for Development", icon: { Graph: { icon: 'Graph' } } }
          ]}
        />
      </div>
