...
export const metadata: Metadata = {
  ...
  description: "Create a high-converting, single-page SaaS landing with clear sections for introduction, about, purchase flow, value metrics, and trust signals.",
};
